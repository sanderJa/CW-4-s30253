...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldSelectNamesAndSalaries()
    {
        ...
        var result = emps.Select(emp => (emp.EName, emp.Sal)).ToList();
    ...
    public void ShouldJoinEmployeesWithDepartments()
    {
        ...
        var result = emps.Join(depts, e => e.DeptNo, d => d.DeptNo, (e, d) => (e.EName, d.DName)).ToList();
    ...
    public void ShouldCountEmployeesPerDepartment()
    {
        ...
        var
            result = emps.GroupBy(e => e.DeptNo).Select(g => new { DeptNo = g.Key, Count = g.Count() }).ToList();
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps.Join(grades, e => true, s => true, (e, s) => new { e.EName, s.Grade, e.Sal, s.Losal, s.Hisal })
            .Where(e => e.Sal <= e.Hisal && e.Sal >= e.Losal).ToList();
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps.GroupBy(e => e.DeptNo).Select(e => new {DeptNo = e.Key,AvgSal = e.Average(d => d.Sal)}).ToList(); 
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(e => e.Sal > emps.Where(em => em.DeptNo == e.DeptNo).Average(emp => emp.Sal)).Select(e => e.EName); 
