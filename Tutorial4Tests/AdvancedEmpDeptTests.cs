...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps.Join(depts, e => e.DeptNo, d => d.DeptNo, (e, d) => new { e.EName, e.Sal, d.DName })
            .Join(grades, ed => true, g => true, (ed, g) => new { ed.EName, ed.DName, ed.Sal, g.Grade, g.Losal, g.Hisal })
            .Where(s => s.Sal >= s.Losal && s.Sal <= s.Hisal)
            .Select(e => new { e.EName, e.DName, e.Grade })
            .ToList(); 
